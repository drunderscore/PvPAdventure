...
//    public SpawnState spawnSelectorState;
...
//        Enabled &&
//        Main.LocalPlayer.GetModPlayer<SpawnPointPlayer>().IsPlayerInSpawnRegion();
...
//    public static bool IsMapTeleportGated // gated meaning requires timer or instant teleport
//    {
//        get
//        {
...
//        spawnSelectorState = new SpawnState();
...
//        bool inSpawnRegion = Main.LocalPlayer.GetModPlayer<SpawnPointPlayer>().IsPlayerInSpawnRegion();
...
//            SetEnabled(true);
//        }
//        else if (playing && (Main.mapFullscreen || IsFullscreenMapTemporarilyClosedForSpectate))
//        {
//            SetEnabled(true);
//        }
//        else
