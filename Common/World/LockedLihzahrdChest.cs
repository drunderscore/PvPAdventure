...
public class LockedLihzahrdChest : ModTile
{
    ...
    // TODO: This is pretty scuffed and would be more easily solved by just changing the amount of chests spawn in vanilla worldgen instead of placing our own chests manually like this.
        ...
        for (int i = 0; i < extraChests; i++)
        {
            ...
            while (!placed && attempts < 1000)
            {
                ...
                if (WorldGen.InWorld(x, y) && WorldGen.InWorld(x + 1, y + 1))
                {
                    ...
                    if (tile.WallType == WallID.LihzahrdBrickUnsafe && !tile.HasTile &&
                        tileRight.WallType == WallID.LihzahrdBrickUnsafe && !tileRight.HasTile &&
