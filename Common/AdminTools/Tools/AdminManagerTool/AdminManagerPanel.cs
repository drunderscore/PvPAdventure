...
internal class AdminManagerPanel : UI.DraggablePanel
{
    ...
    public sealed class AdminToggleIconElement : UIElement
    {
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            // Draw centered with custom scale
            spriteBatch.Draw(
                tex,
            ...
            if (IsMouseHovering)
            {
                string toggleText = getIsOn() ? "Disable admin access for " : "Enable admin access for ";
                toggleText += player.name;

                Main.instance.MouseText(toggleText);
            }
        }
    }
}
