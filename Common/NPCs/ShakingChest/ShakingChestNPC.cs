...
public class ShakingChestNPC : GlobalNPC
{
    ...
    public static readonly NPCShop Shop = new NPCShop(NPCID.BoundTownSlimeOld, ShopName)
        ...
        .Add(new Item(ItemID.RegenerationPotion) { shopCustomPrice = Item.buyPrice(silver: 420) })
        .Add(new Item(ItemID.SpelunkerPotion) { shopCustomPrice = Item.buyPrice(copper: 66666) })
