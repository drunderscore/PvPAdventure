...
internal class SpawnUIPositionConfigElement : ConfigElement
{
    ...
    private void LiveApply(Vector2 pos)
    {
        ...
        var panel = sys?.spawnSelectorState?.basePanel;
        var title = sys?.spawnSelectorState?.chooseYourSpawnPanel;
