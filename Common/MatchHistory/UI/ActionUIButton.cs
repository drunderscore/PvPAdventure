...
public sealed class ActionUIButton<TText> : UITextPanel<TText>
{
    public ActionUIButton(TText text, Action onClick, float textScale = 0.7f, bool large = true) : base(text, textScale, large)
    {
