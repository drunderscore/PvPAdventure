...
public sealed class DownloadUIButton : UITextPanel<string>
{
    ...
    public DownloadUIButton(Action onClick, Func<string> getDownloadedLabel, float textScale = 0.7f, bool large = true)
    ...
    private static string? PickNewest(string folder, DateTime t)
    {
        ...
        string[] files = Directory.GetFiles(folder, prefix + "*.json", SearchOption.TopDirectoryOnly);
