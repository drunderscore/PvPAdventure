...
internal class CombatPlayer : ModPlayer
{
    ...
    {
        if (npc.boss || NpcHelpers.IsPartOfEaterOfWorlds((short)npc.type) ||
            NpcHelpers.IsPartOfTheDestroyer((short)npc.type) || BossNpcsForImmunityCooldown.Contains((short)npc.type))
