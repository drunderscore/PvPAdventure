...
internal class CombatPlayer : ModPlayer
{
    ...
    {
        if (npc.boss || TeamBossNPC.IsPartOfEaterOfWorlds((short)npc.type) ||
            TeamBossNPC.IsPartOfTheDestroyer((short)npc.type) || BossNpcsForImmunityCooldown.Contains((short)npc.type))
