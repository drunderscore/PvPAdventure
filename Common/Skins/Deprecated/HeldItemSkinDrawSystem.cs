...
///// <summary>
///// Hooks into the held-item draw layer to swap the vanilla weapon texture
///// with the owning player's selected skin texture.
///// Works for both the local player and remote players in multiplayer.
///// </summary>
//internal sealed class HeldItemSkinDrawSystem : ModSystem
//{
...
//    private static void SwapHeldItemTexture(
//        On_PlayerDrawLayers.orig_DrawPlayer_27_HeldItem orig,
...
//        if (!player.TryGetModPlayer(out SkinPlayer skinPlayer) ||
//            !skinPlayer.TryGetSkin(item.type, out SkinDefinition def))
//        {
//            orig(ref drawInfo);
//            return;
//        }

//        Texture2D skinTex = def.Texture.Value;
...
//        // Let vanilla draw as normal, then patch the draw data afterwards.
//        orig(ref drawInfo);

//        float scaleRatio = SkinGlobalItem.GetScaleRatio(item, skinTex);
