...
//        if (item == null || item.IsAir || !ItemSkinDefinition.HasAnySkins(item.type))
//        {
//            orig(ref drawInfo);
//            return;
//        }

//        if (!item.TryGetGlobalItem(out ItemSkinsGlobalItem skins))
//        {
//            orig(ref drawInfo);
//            return;
//        }

//        byte skinIndex = skins.GetActiveSkinIndex(item);

//        if (!ItemSkinDefinition.TryGetSkin(item.type, skinIndex, out Texture2D skinTex, out _))
//        {
//            orig(ref drawInfo);
//            return;
//        }
