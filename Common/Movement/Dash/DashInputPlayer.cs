...
public class DashInputPlayer : ModPlayer
{
    ...
    {
        DebugLog.Chat($"Dashing with Tabi in direction: {direction} and velocity {16.9f}");
    ...
    {
        DebugLog.Chat($"Dashing with Shield in direction: {direction} and velocity {14.5f}");
    ...
    {
        DebugLog.Chat($"Dashing with Solar in direction: {direction} and velocity {21.9f}");
    ...
    {
        DebugLog.Chat($"Dashing with Crystal in direction: {direction} and velocity {16.9f}");
