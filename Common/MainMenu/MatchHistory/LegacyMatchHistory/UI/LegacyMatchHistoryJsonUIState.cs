...
/// </summary>
public sealed class LegacyMatchHistoryJsonUIState : ResizableUIState
{
    // Content
    ...
    {
        matchesBaseElement = new UIElement
        {
        ...
        backPanel.Append(new UITextPanel<string>("Legacy Match History", 0.9f, true)
        {
        ...
        var matchScrollbar = new UIScrollbar
        {
    ...
    public override void OnActivate()
    {
        ...
        string folder = MatchJsonStorage.GetFolderPath();
        matches.Clear();
        matches.AddRange(MatchJsonStorage.LoadMatchesFromFolder(folder));
        matchList.Clear();
        rows.Clear();
