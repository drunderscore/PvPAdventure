...
//public class TPVPACharacterSelectUIState : UIState
//{
...
//        //Main.menuMode = 0;
//        PlayMenuFlow.ReturnToBrowser(); // CHANGED
//    }
...
//        {
//            this._playerList.Add(new TPVPACharacterListItem(item, num++));
//        }
//    }
...
//            foreach (PlayerFileData item in list)
//            {
//                this.favoritesCache.Add(Tuple.Create(item.Name, item.IsFavorite));
//            }
